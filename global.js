...
var setTabla_trans_min = function(matriz){
	return info.tabla_trans_min = matriz ;
}

var getTabla_trans_min = function(){
	return info.tabla_trans_min;
}
...
module.exports = {	
	...
	setTabla_trans_min: setTabla_trans_min,
	getTabla_trans_min: getTabla_trans_min
};